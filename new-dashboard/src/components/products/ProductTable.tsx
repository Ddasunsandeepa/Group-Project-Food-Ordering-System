        ...
        <table className="min-w-full divide-y divide-gray-800">
          <thead className="bg-gray-900">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs hidden md:block font-medium text-gray-200 uppercase tracking-wider">
                Category
              </th>
              <th className="px-4 py-3 text-left hidden md:block text-xs font-medium text-gray-200 uppercase tracking-wider">
                Discount
              </th>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">
                Price
